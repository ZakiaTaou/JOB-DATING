...
export default function RecruiterProfile() {
  ...
  const handleSave = () => {
    if (!formData.companyName || !formData.description) {
      Alert.alert('Erreur', 'Le nom de l\'entreprise et la description sont requis');
      return;
    }

    if (formData.description.length < 50) {
      Alert.alert('Erreur', 'La description doit contenir au moins 50 caractères');
      return;
    }
        ...
        <View style={styles.radioGroup}>
          {[
            ...
            <TouchableOpacity
              ...
              style={[
                styles.radioButton,
                formData.companySize === option.value && styles.radioButtonActive
              ]}
              onPress={() => setFormData({ ...formData, companySize: option.value })}
            >
              <Text
                style={[
                  styles.radioText,
                  formData.companySize === option.value && styles.radioTextActive
                ]}
              >
                {option.label}
              </Text>
...
// ============================================
// Styles partagés (shared-styles.js)
// ============================================
